...
from models import *
from regularizers import N3, Linear3, Lambda3
from case_study import run_specific_case_study, export_all_predictions
...
def learn(model=args.model,
    ...
    model = {
        ...
        'TACAS': TACAS(sizes, rank, no_time_emb=args.no_time_emb),
        'TComplEx': TComplEx(sizes, rank, no_time_emb=args.no_time_emb),
        # 'TeAST': TACAS_C(sizes, rank, no_time_emb=args.no_time_emb)
    ...
    for epoch in range(args.max_epochs):
        ...
        if epoch < 0 or ((epoch + 1) % args.valid_freq == 0 and epoch > 0):
